fn main() {
    ...
    //      Specify an integer inside '{}' determines which additional argument will be replaced.
    //      Arguments start at 0 immediatly after the format string."
    println!("{0}, this is {1}. {1}, this is {0}", "Alice", "Bob");

    // "As can name arguments."
    println!("{subject} {verb} {object}",
            object="the lazy dog",
            subject="the quickbrown fox",
            verb="jumps over");
    ...
    // "You can pad number with extra zeroes,"
    ...
    #[allow(dead_code)] // "Disable 'dead_code' which warn"s" against unused module" 
